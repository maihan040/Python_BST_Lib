...
# than the parent															 			#
# 						                                            					#
# Input parameters: "root" which is the root of the current binary search tree where	#
# 				   user wishes to add a new node										#
# 				   "val" the value of the new node that will need to be added to the 	#
# 			       tree.																#
# 																						#
# Output: Nothing																		#
#########################################################################################
